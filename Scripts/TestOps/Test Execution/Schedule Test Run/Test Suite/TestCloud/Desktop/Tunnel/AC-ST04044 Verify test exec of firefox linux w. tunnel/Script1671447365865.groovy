...
String testRunName = "firefox-${browserVersion}-linux-private-site-" + new DateTimeUtility().getCurrentDateTime()
...
Page.nav(TestRunListPage).verifyTestRunName(1, testRunName)
							...
							.verifyTestRunTestEnv(1, 'TestCloud Linux Firefox ' + browserVersion)
