...
String testRunName = "safari-${browserVersion}-macOS-private-site-" + new DateTimeUtility().getCurrentDateTime()
...
Page.nav(TestRunListPage).verifyTestRunName(1, testRunName)
							...
							.verifyTestRunTestEnv(1, "TestCloud MacOS Safari ${browserVersion}")
