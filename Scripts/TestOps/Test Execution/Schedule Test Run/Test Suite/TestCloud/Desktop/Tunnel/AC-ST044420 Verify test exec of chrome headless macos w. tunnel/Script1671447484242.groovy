...
String testRunName = "chrome-headless-${browserVersion}-macos-private-site-" + new DateTimeUtility().getCurrentDateTime()
...
Page.nav(TestRunListPage).verifyTestRunName(1, testRunName)
							...
							.verifyTestRunTestEnv(1, 'TestCloud MacOS Chrome headless ' + browserVersion)
