...
String testRunName = "firefox-headless-${browserVersion}-windows-private-site-" + new DateTimeUtility().getCurrentDateTime()
...
Page.nav(TestRunListPage).verifyTestRunName(1, testRunName)
							...
							.verifyTestRunTestEnv(1, 'TestCloud Windows Firefox headless ' + browserVersion)
