...
String testRunName = "ie-${browserVersion}-windows-private-site-" + new DateTimeUtility().getCurrentDateTime()
...
Page.nav(TestRunListPage)
	...
	.verifyTestRunTestEnv(1, 'TestCloud Windows IE ' + browserVersion)
