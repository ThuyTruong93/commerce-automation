...
String testRunName = "TSC-linux-default-public-" + new DateTimeUtility().getCurrentDateTime()
String scriptRepo = 'cloudian-automation-1'
String tscPath = 'Test Suites/TSC/TSC with 4 passed WA TS for linux (default)'
