...
String testRunName = "TSC-linux-private-" + new DateTimeUtility().getCurrentDateTime()
String scriptRepo = 'cloudian-automation-1'
String tscPath = 'Test Suites/TSC/TSC with 4 passed WA TS with tunnel'
...
String expectedEnv = """TestCloud Linux Chrome 107
TestCloud Linux Chrome Headless 106
TestCloud Linux Firefox 106
TestCloud Linux Firefox Headless 105"""
