...
String testRunName = "Test execute with Katalon command " + new DateTimeUtility().getCurrentDateTime()
...
Page.nav(TestRunListPage).verifyTestRunName(1, testRunName)
							...
							.verifyTestRunTestEnv(1, 'TestCloud Linux Chrome ' + browserVersion)
