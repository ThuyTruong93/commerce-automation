...
String testRunName = "generic-command-local-agent-" + new DateTimeUtility().getCurrentDateTime()
String localEnv = 'cloudian-local-agent-1'
...
Page.nav(TestRunListPage)
	...
	.verifyTestRunTestEnv(1, localEnv)
...
Page.nav(TestRunsPage)
	.waitUntilTestRunIncomplete(1, 60 * 10)
	.verifyTestRunName(1, testRunName)
	.clickTestRunId(1)
...
Page.nav(TestRunDetailPage)
	...
	.verifySessionTestEnv(1, localEnv)
	.clickSessionId(1)
